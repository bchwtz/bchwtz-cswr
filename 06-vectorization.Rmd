...
The paradigm of vectorization is closedly linked to functional programming and one can find a few reasons (e.g. execution speed in some cases), to make use of them. A very comparable set of functions an some additional patterns are implementd in the `purrr` package that is part of the `tidyverse`. 
