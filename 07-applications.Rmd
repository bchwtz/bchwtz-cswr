...
(ref:histogram-t-w) Histograms of the temperature and the wind speed of the `airquality` dataset [@datasets].
...
(ref:box-t-w) Boxplots of the temperature and the wind speed of the `airquality` dataset [@datasets].
...
(ref:b-wind) Boxplot of the wind speed of the `airquality` dataset [@datasets].
...
```{r, eval=FALSE, fig.cap = "(ref:ggplotly-air-lm)"}
...
```{r, eval=FALSE, fig.cap = "(ref:plotly-3d)"}
